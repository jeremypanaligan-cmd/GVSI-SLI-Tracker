...
export default function ExecutiveOverview({ metrics, onGoToDetail }) {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-3 sm:px-6 py-6 space-y-6">
      ...
      {/* Progress Bar */}
      <div className="bg-white dark:bg-slate-900/60 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 sm:p-6">
...
function KPICard({ label, value, sublabel, badge, large, accent }) {
  ...
  return (
    <div className={`bg-white dark:bg-slate-900/60 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-4 ${borderClass ? 'border-l-4 ' + borderClass : ''}`}>
